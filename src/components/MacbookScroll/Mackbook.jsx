...
export const MacbookScroll = ({ src, showGradient, title, badge }) => {
  ...
  const imgScale = useTransform(scrollYProgress, [0.8, 1], [1, 1.2]);
  ...
  return (
    ...
    >
      <motion.h2
        ...
        className="mb-30 text-center text-6xl font-bold text-neutral-800 dark:text-white"
      >
        {title || (
          <span>
            Estratégia de{" "}
            <span class="font-bold bg-linear-to-r from-sky-400 to-cyan-400 bg-clip-text text-transparent">
              impacto
            </span>
            <br /> Simples.
          </span>
...
export const Lid = ({ scaleX, scaleY, rotate, translate, src, imgScale }) => {
  return (
    <div className="relative [perspective:800px]">
      ...
      {/* Aqui aplicamos o imgScale junto com o restante das transforms */}
      <motion.div
        style={{
          scale: imgScale,
          scaleX: scaleX,
